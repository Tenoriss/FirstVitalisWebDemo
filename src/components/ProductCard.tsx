...
export const ProductCard = memo(function ProductCard({
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl border bg-card shadow-soft hover-lift">
      <Link
        to="/products/$id"
      ...
      <div className="flex flex-1 flex-col gap-2 p-4">
        ...
        <Button
          ...
          className="bg-primary-gradient shadow-soft transition-transform hover:scale-[1.02]"
        >
